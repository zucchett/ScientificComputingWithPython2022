...
Original file is located at
    https://colab.research.google.com/drive/1pmanC8fOuEPzxhVGhs5s-SaOX6PYDIAl
...
data = pd.read_csv('/content/regression_generated (1).csv')
